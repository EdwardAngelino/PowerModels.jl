...
#cbc_solver = JuMP.with_optimizer(AmplNLWriter.Optimizer, Ipopt.amplexe, ["print_level=0"])   # prueba corre con Ipopt
cbc_solver = JuMP.with_optimizer(AmplNLWriter.Optimizer,"/Users/Edward/Downloads/couenne-osx/couenne", ["print_level=0"])
#cbc_solver = JuMP.with_optimizer(AmplNLWriter.Optimizer,"/Users/Edward/Downloads/bonmin-osx/bonmin", ["print_level=0"])
